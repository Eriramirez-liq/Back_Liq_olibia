-- Borrar tablas (CASCADE elimina dependencias automáticamente)
DROP TABLE IF EXISTS "log_auditoria" CASCADE;
DROP TABLE IF EXISTS "cruces_balance" CASCADE;
DROP TABLE IF EXISTS "disputas" CASCADE;
DROP TABLE IF EXISTS "contingencias" CASCADE;
DROP TABLE IF EXISTS "provisiones" CASCADE;
DROP TABLE IF EXISTS "resultados_conciliacion" CASCADE;
DROP TABLE IF EXISTS "registros_cot" CASCADE;
DROP TABLE IF EXISTS "registros_balance" CASCADE;
DROP TABLE IF EXISTS "registros_tc1" CASCADE;
DROP TABLE IF EXISTS "registros_sdl" CASCADE;
DROP TABLE IF EXISTS "registros_xm" CASCADE;
DROP TABLE IF EXISTS "registros_facturacion" CASCADE;
DROP TABLE IF EXISTS "cargas_fuente" CASCADE;
DROP TABLE IF EXISTS "configuracion_or" CASCADE;
DROP TABLE IF EXISTS "periodos_conciliacion" CASCADE;
DROP TABLE IF EXISTS "users" CASCADE;

-- Borrar enums
DROP TYPE IF EXISTS "AccionAuditoria" CASCADE;
DROP TYPE IF EXISTS "EstadoDisputa" CASCADE;
DROP TYPE IF EXISTS "TipoResultadoCruce" CASCADE;
DROP TYPE IF EXISTS "ResultadoContingencia" CASCADE;
DROP TYPE IF EXISTS "EstadoContingencia" CASCADE;
DROP TYPE IF EXISTS "EstadoProvision" CASCADE;
DROP TYPE IF EXISTS "TipoProvision" CASCADE;
DROP TYPE IF EXISTS "ResultadoLinea" CASCADE;
DROP TYPE IF EXISTS "CasoConciliacion" CASCADE;
DROP TYPE IF EXISTS "EstadoPeriodo" CASCADE;
DROP TYPE IF EXISTS "EstadoCarga" CASCADE;
...
-- CreateEnum
CREATE TYPE "TipoFuente" AS ENUM ('FACTURACION', 'XM', 'SDL', 'BALANCE', 'TC1', 'COT');
...
CREATE TABLE "registros_facturacion" (
    ...
    "operador_red" TEXT NOT NULL,
    "energia_kwh" DECIMAL(18,6) NOT NULL,
    "g_bia" DECIMAL(18,6) NOT NULL,
    "t_bia" DECIMAL(18,6) NOT NULL,
    "d_bia" DECIMAL(18,6) NOT NULL,
    "pr_bia" DECIMAL(18,6) NOT NULL,
    "r_bia" DECIMAL(18,6) NOT NULL,
    "c_bia" DECIMAL(18,6) NOT NULL,
    "tarifa_total_bia" DECIMAL(18,6) NOT NULL,
    "createdAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
